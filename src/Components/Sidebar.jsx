  ...
  return (
    ...
    <div className='top'>
      ...
      <div className='side' style={{width:isOpen ? "70px" : "300px"}}>
        ...
        <NavLink to= '/Track' className='link' activeclassName = 'active'>
          <div className='bar'>
            <span><AiFillSetting className='icon'/></span>
            <span className='text' style={{display:isOpen ? "none" : "block"}}>Track</span>
          </div>
        </NavLink>

        <NavLink to= '/Registration' className='link' activeclassName = 'active'>
          <div className='bar'>
